...
using ntu.xzmcwjzs.Web.Controllers.Results;
using ntu.xzmcwjzs.Web.Models.Account;
using Microsoft.AspNet.Identity;
using Microsoft.AspNet.Identity.Owin;
using Microsoft.Owin.Security;

namespace ntu.xzmcwjzs.Web.Controllers
{
    public class AccountController : xzmcwjzsControllerBase
    {
